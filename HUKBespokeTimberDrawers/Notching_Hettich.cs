...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Notching_Hettich recording.
    /// </summary>
    [TestModule("eb375849-9332-4060-913b-dc0bf2e1e3d2", ModuleType.Recording, 1)]
    public partial class Notching_Hettich : ITestModule
    {
        /// <summary>
        ...
        static Notching_Hettich instance = new Notching_Hettich();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Notching_Hettich()
        {
        }
        ...
        /// </summary>
        public static Notching_Hettich Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking EnsureVisible() on item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_Hettich'.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_HettichInfo, new RecordItemIndex(3));
            repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_Hettich.EnsureVisible();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_Hettich' at Center.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_HettichInfo, new RecordItemIndex(4));
            repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_Hettich.Click();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating ContainsImage (Screenshot: 'Screenshot2' with region {X=0,Y=0,Width=135,Height=44}) on item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_Hettich'.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_HettichInfo, new RecordItemIndex(5));
