...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Notching_None recording.
    /// </summary>
    [TestModule("6fab2d9b-23ce-4d17-a1fd-fc17c26497b9", ModuleType.Recording, 1)]
    public partial class Notching_None : ITestModule
    {
        /// <summary>
        ...
        static Notching_None instance = new Notching_None();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Notching_None()
        {
        }
        ...
        /// </summary>
        public static Notching_None Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking EnsureVisible() on item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_None'.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_NoneInfo, new RecordItemIndex(3));
            repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_None.EnsureVisible();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_None' at Center.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_NoneInfo, new RecordItemIndex(4));
            repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_None.Click();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating ContainsImage (Screenshot: 'Screenshot1' with region {X=0,Y=0,Width=135,Height=44}) on item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_None'.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_NoneInfo, new RecordItemIndex(5));
