...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The BTD13_Engraving_AddEngraving_Yes recording.
    /// </summary>
    [TestModule("68075922-3de1-469f-8306-e2b0dad96448", ModuleType.Recording, 1)]
    public partial class BTD13_Engraving_AddEngraving_Yes : ITestModule
    {
        /// <summary>
        ...
        static BTD13_Engraving_AddEngraving_Yes instance = new BTD13_Engraving_AddEngraving_Yes();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public BTD13_Engraving_AddEngraving_Yes()
        {
        }
        ...
        /// </summary>
        public static BTD13_Engraving_AddEngraving_Yes Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking EnsureVisible() on item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Engraving_Yes'.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Engraving_YesInfo, new RecordItemIndex(3));
            repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Engraving_Yes.EnsureVisible();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Engraving_Yes' at Center.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Engraving_YesInfo, new RecordItemIndex(4));
            repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Engraving_Yes.Click();
            Delay.Milliseconds(200);
