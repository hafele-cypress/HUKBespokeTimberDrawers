...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Finish_LacqueredBaseUnderside_No recording.
    /// </summary>
    [TestModule("b87725a8-9e3d-4454-a16b-85ae5e306104", ModuleType.Recording, 1)]
    public partial class Finish_LacqueredBaseUnderside_No : ITestModule
    {
        /// <summary>
        ...
        static Finish_LacqueredBaseUnderside_No instance = new Finish_LacqueredBaseUnderside_No();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Finish_LacqueredBaseUnderside_No()
        {
        }
        ...
        /// </summary>
        public static Finish_LacqueredBaseUnderside_No Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking EnsureVisible() on item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Finish_LacqueredBase_Underside_No'.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Finish_LacqueredBase_Underside_NoInfo, new RecordItemIndex(3));
            repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Finish_LacqueredBase_Underside_No.EnsureVisible();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Finish_LacqueredBase_Underside_No' at Center.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Finish_LacqueredBase_Underside_NoInfo, new RecordItemIndex(4));
            repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Finish_LacqueredBase_Underside_No.Click();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating ContainsImage (Screenshot: 'Screenshot1' with region {X=0,Y=0,Width=135,Height=44}) on item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Finish_LacqueredBase_Underside_No'.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Finish_LacqueredBase_Underside_NoInfo, new RecordItemIndex(5));
