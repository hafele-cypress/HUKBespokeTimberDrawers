...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The BTD8_Notching_Grass recording.
    /// </summary>
    [TestModule("05ee3f88-331b-4700-98b4-7ac69af7263d", ModuleType.Recording, 1)]
    public partial class BTD8_Notching_Grass : ITestModule
    {
        /// <summary>
        ...
        static BTD8_Notching_Grass instance = new BTD8_Notching_Grass();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public BTD8_Notching_Grass()
        {
        }
        ...
        /// </summary>
        public static BTD8_Notching_Grass Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking EnsureVisible() on item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_Grass'.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_GrassInfo, new RecordItemIndex(4));
            repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_Grass.EnsureVisible();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_Grass' at Center.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_GrassInfo, new RecordItemIndex(5));
            repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_Grass.Click();
            Delay.Milliseconds(200);
            
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating ContainsImage (Screenshot: 'Screenshot1' with region {X=0,Y=0,Width=135,Height=44}) on item 'MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_Grass'.", repo.MyHafelePortal.HttpsQmyHafeleCoUkQuotesBespoke.Notching_GrassInfo, new RecordItemIndex(6));
